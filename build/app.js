...
const bukalapakRoutes_1 = __importDefault(require("./app/routes/bukalapakRoutes"));
const blibliRoutes_1 = __importDefault(require("./app/routes/blibliRoutes"));
const authRoutes_1 = __importDefault(require("./app/routes/authRoutes"));
const storeRoutes_1 = __importDefault(require("./app/routes/storeRoutes"));
